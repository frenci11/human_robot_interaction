...
C_current_auto = tunablePID('C_current_autotuned','pi');
C_velocity_auto = tunablePID('C_velocity_autotuned','pi');
C_position_auto = tunablePID('C_position_autotuned','pd');
...
current_subsystem = in_current * feedback(C_current_auto * motor_current, 1) * out_current;
velocity_subsystem = in_velocity * feedback(C_velocity_auto * current_subsystem * K * in_torque_disturbance * Me, 1) * out_velocity;
position_system = feedback(C_position_auto * velocity_subsystem * 1/s, 1);
